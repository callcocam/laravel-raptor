...
export const sidebarMenuButtonVariants = cva(
    [
        'peer/menu-button relative flex w-full items-center gap-2 overflow-hidden rounded-md px-2.5 text-left text-sm outline-hidden',
        ...
        '[&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-foreground/40 [&>svg]:transition-colors',
    ...
    ].join(' '),
    {
        variants: {
            variant: {
                default: '',
                outline: 'border border-sidebar-border bg-sidebar-accent/20 hover:bg-sidebar-accent',
            },
            size: {
                default: 'h-8 text-sm',
                sm: 'h-7 text-xs px-2',
